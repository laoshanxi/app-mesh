...
5. Additional, integrate Coverity with Github Action automaticlly refer to: [coverity_workflow](https://github.com/laoshanxi/app-mesh/blob/main/.github/workflows/security-coverity.yml)
