...
const std::string Utility::b64encode(const void *data, const size_t &len)
{
...
const std::string Utility::b64decode(const void *data, const size_t &len)
{
...
/*
std::string Utility::b64encode(const std::string &str)
{
	return b64encode(str.c_str(), str.size());
}

std::string Utility::b64decode(const std::string &str64)
{
