...
// lws init
// -------------------------------
bool WebSocketService::initializeLwsContext(const char *cert_path, const char *key_path, const char *ca_path)
{
    const static char fname[] = "WebSocketService::initializeLwsContext() ";
