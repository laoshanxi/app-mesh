...
PROG_HOME="$(cd "$(dirname "$(readlink -f "${BASH_SOURCE[0]}" 2>/dev/null || echo "${BASH_SOURCE[0]}")")/.." && pwd -P)"
export LD_LIBRARY_PATH="${PROG_HOME}/lib64${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"
