...
impl StoredSession {
    pub fn new(engine_endpoint: String, oauth: OAuthConfig, tokens: TokenSet) -> Self {
...
/// Atomically persist a complete token set and its issuer/client/audience binding.
