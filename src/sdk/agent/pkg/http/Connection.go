...
func NewConnection(targetHost string, allowError bool) (*Connection, error) {
	...
	conn, err := connectAppMeshServer(targetHost)
	if err != nil {
		return nil, err
	}
...
func connectAppMeshServer(tcpAddr string) (net.Conn, error) {
