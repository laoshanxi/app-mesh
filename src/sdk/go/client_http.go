...
// GetAuthConfig returns the public OAuth/OIDC configuration advertised by Engine.
...
// GetCurrentPrincipal returns the verified principal represented by the bearer.
...
// ListPrincipals returns App Mesh authorization overlays keyed by immutable principal ID.
