// src/daemon/security/ldapplugin/SecurityLDAP.cpp
#include <ace/OS.h>
...
bool SecurityLDAP::syncGroupUsers()
{
    ...
    {
        m_syncTimerId = this->registerTimer(1000L, 1000L * m_ldap->m_syncSeconds, fname, std::bind(&SecurityLDAP::syncGroupUsers, this));
    }
    return true;
}
