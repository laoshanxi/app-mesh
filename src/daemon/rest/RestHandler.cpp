...
void RestHandler::apiUserAdd(const HttpRequest &message)
{
	...
	auto user = Security::instance()->UsersObject()->addUser(pathUserName, message.extractJson(), Security::instance()->RolesObject());
	Security::instance()->save();
	ConsulConnection::instance()->saveSecurity();
...
void RestHandler::apiUserDel(const HttpRequest &message)
{
	...
	Security::instance()->UsersObject()->delUser(pathUserName);
	Security::instance()->save();
	ConsulConnection::instance()->saveSecurity();
...
void RestHandler::apiUsersView(const HttpRequest &message)
{
	...
	auto users = Security::instance()->UsersObject()->AsJson();
...
void RestHandler::apiRolesView(const HttpRequest &message)
{
	...
	message.reply(status_codes::OK, Security::instance()->RolesObject()->AsJson());
}
...
void RestHandler::apiRoleUpdate(const HttpRequest &message)
{
	...
	Security::instance()->RolesObject()->addRole(message.extractJson(), pathRoleName);
	Security::instance()->save();
	ConsulConnection::instance()->saveSecurity();
...
void RestHandler::apiRoleDelete(const HttpRequest &message)
{
	...
	Security::instance()->RolesObject()->delRole(pathRoleName);
	Security::instance()->save();
	ConsulConnection::instance()->saveSecurity();
...
{
	auto groups = Security::instance()->UsersObject()->getGroups();
