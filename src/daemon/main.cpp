...
int main(int argc, char *argv[])
{
	...
	try
	{
		...
		LOG_INF << fname << "Initializing security with JWT interface: " << Configuration::instance()->getJwt()->getJwtInterface();
		...
		{
			LOG_INF << fname << "Copying Consul config from <" << consulConfigSource << "> to <" << consulConfigTarget << ">";
