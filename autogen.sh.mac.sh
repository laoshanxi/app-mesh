...
# Install C++ libraries
brew install yaml-cpp nlohmann-json msgpack-cxx

# Install curl
curl -o curl.rb https://github.com/laoshanxi/homebrew-core/raw/refs/heads/master/Formula/c/curl.rb
brew install --build-from-source --verbose ./curl.rb
