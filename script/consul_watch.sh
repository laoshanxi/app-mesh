...
# TODO: if send watch event to self failed, and this is the leader node (leader ttl has not expired), then this watch event will be lost, need sleep a while and fresh consul to trigger watch again.
