...
Security |  ⚡️ Authorization: [JWT](https://app-mesh.readthedocs.io/en/latest/JWT.html), [2FA](https://app-mesh.readthedocs.io/en/latest/MFA.html), [RBAC](https://app-mesh.readthedocs.io/en/latest/USER_ROLE.html) and multi-tenant support <br> ⚡️ Authentication plugin support: [LDAP](https://app-mesh.readthedocs.io/en/latest/LDAP.html), [OAuth](src/sdk/python/test/test_oauth2.py) and local storage <br> ⚡️ Security: SSL for all connection, CSRF token, PSK(Pre-Shared Key)
