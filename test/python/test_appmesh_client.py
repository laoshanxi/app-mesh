...
class TestAppMeshClient(TestCase):
    ...
    def test_app_run(self):
        ...
        self.assertEqual(9, client.run_sync(appmesh_client.App({"command": "ping www.baidu.com -w 5", "shell": True}), max_time_seconds=4))
        run = client.run_async(appmesh_client.App({"command": "ping www.baidu.com -w 4", "shell": True}), max_time_seconds=5)
        self.assertEqual(0, run.wait())
    ...
    def test_app_mgt(self):
        ...
        client = appmesh_client.AppMeshClient()
        client.login("admin", "admin123")
        app = client.app_add(appmesh_client.App({"command": "ping www.baidu.com -w 5", "name": "SDK"}))
        self.assertTrue(hasattr(app, "name"))
