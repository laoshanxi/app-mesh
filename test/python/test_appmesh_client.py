...
class TestAppMeshClient(TestCase):
    ...
    def test_app_run(self):
        ...
        self.assertEqual(9, client.run_sync(appmesh_client.App({"command": "ping www.baidu.com -w 5", "shell": True}), max_time_seconds=3))
        run = client.run_async(appmesh_client.App({"command": "ping www.baidu.com -w 3", "shell": True}), max_time_seconds=6)
